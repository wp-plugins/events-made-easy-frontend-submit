   ...
   class EMEFS_Settings {
      ...
      function condition_box() {
         ?>
          ...
          eme_options_radio_binary (__('Enable Google Maps integration?','emefs'), $this->get_field_name('gmap_enabled'), __ ( 'Check this option to enable Google Map integration', 'emefs' ), $this->get_field_value('gmap_enabled'));
